...
const IMAGE = "https://huntshowdown.wiki.gg/images/Weapon_Mosin_Obrez_Match.png"
...
export const MOSIN_OBREZ_MATCH: Weapon = new Weapon({
  name: NAME,
  cost: COST,
  size: SIZE,
  action: ACTION,
