...
const IMAGE = "https://huntshowdown.wiki.gg/images/Weapon_Scottfield_Spitfire.png"
...
export const SCOTTFIELD_SPITFIRE: Weapon = new Weapon({
  name: NAME,
  cost: COST,
  size: SIZE,
  action: ACTION,
