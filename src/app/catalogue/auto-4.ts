...
const IMAGE = "https://huntshowdown.wiki.gg/images/Weapon_Auto-4_Shorty.png";
...
export const AUTO_4_SHORTY: Weapon = new Weapon({
  name: NAME,
  cost: COST,
  size: SIZE,
  action: ACTION,
