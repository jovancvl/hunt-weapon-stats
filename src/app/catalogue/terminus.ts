...
const IMAGE = "https://huntshowdown.wiki.gg/images/Weapon_Terminus.png";
...
export const TERMINUS: Weapon = new Weapon({
  name: NAME,
  cost: COST,
  size: SIZE,
  action: ACTION,
