...
const NAME = "Specter 1882 Shorty"
const COST = 164
const SIZE = 2
...
const IMAGE = "https://huntshowdown.wiki.gg/images/Weapon_Specter_1882_Shorty.png"
...
export const SPECTER_1882_SHORTY: Weapon = new Weapon({
  name: NAME,
  cost: COST,
  size: SIZE,
  action: ACTION,
