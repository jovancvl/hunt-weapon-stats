...
export const COMPACT_AMMO_FILTER = new BaseAmmoFilter(new Set([AmmoName.COMPACT]), "ammo-icons/ammo_filter-compact.svg")
export const MEDIUM_AMMO_FILTER = new BaseAmmoFilter(new Set([AmmoName.MEDIUM]), "ammo-icons/ammo_filter-medium.svg")
export const LONG_AMMO_FILTER = new BaseAmmoFilter(new Set([AmmoName.LONG]), "ammo-icons/ammo_filter-long.svg")
export const BUCKSHOT_AMMO_FILTER = new BaseAmmoFilter(new Set([AmmoName.BUCKSHOT]), "ammo-icons/ammo_filter-shell.svg")
